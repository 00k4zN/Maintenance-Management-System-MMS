          ...
          <div class="col-md-6  mt-5">
            <div class="card mt-5">
              ...
              <div class="card-text m-3 ">
                    ...
                    <div> 
                        <label for="ad"> Sicil No:</label>
                        <label > 16565156</label>
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="ad"> Soyadı:</label>
                        <label > ÖZER</label>
                    </div>

                    <div>
                        <label for="ad"> Mevki:</label>
                        <label > YBS</label>
                    </div>

                    <div>
                        <label for="ad"> Sisteme Son Giriş Zamanı :</label>
                        <label > 12:30 01/08/2022</label>
                    </div>
